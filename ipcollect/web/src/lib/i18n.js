...
export const STRINGS = {
  zh: {
    ...
    t_country: '国家/地区', t_gen: '生成', legend: '图例', best: '代表观测路径（完整路径中 peer 观测最多）',
    ov_sources: '采集点', ov_snap: '数据快照', ov_ingest: '入库', ov_data: '数据版本', ov_build: '前端构建', ov_na: '无数据',
    ov_hint: '选一个国家/地区，或搜 IP / ASN / AS_PATH 开始分析',
    ...
    clear: '清空', src_home: '项目主页', feedback: '问题反馈', changelog: '更新日志', menu: '菜单', friends: '友情链接',
    about: '关于', theme: '主题',
    ...
    loading: '正在加载查询引擎 (DuckDB-WASM)…', loading_ext: '正在加载 parquet 扩展…', querying: '查询中…',
    searching_global: '全表 AS_PATH 搜索中（扫描全表，可能较慢）…',
    col_prefix: '前缀', col_origin: 'origin asn', col_loc: '位置', col_path: '#path',
    col_seg: '本段', col_match: '匹配观测', match_majority: '超过半数 peer 观测匹配',
    match_hint: '匹配 peer 观测 / 本前缀已导出的全部 peer 观测', no_results: '无结果', no_data_cc: '该国家暂无数据',
    ...
    exp_irr: 'IRR 状态', exp_moas: 'MOAS 源数', exp_best: '代表观测路径', exp_segs: '覆盖网段',
    exp_match_peers: '匹配 peer 观测', exp_observed_peers: '全部已导出 peer 观测', exp_match_share: '匹配观测占比',
    no_cover: '库内无前缀覆盖该 IP', query_failed: '查询失败',
    no_visible_path: '库内无可见路径：该 IP 未被任何采集点观测到。',
    ...
    rel_show_all: '展开全部 {n} 个', rel_collapse: '收起',
    ...
    sp_egress: '接入出口', sp_paths_title: '去重路径', sp_noup: '未观测到上游', sp_best: '代表', sp_next: '翻到下一张', sp_card_n: '第 {i} / {n} 张',
    ...
    rt_north_lock: '锁定正北', rt_north_unlock: '解除正北锁定',
    ...
    rt_collapse_all: '收起全部', rt_expand_all: '展开全部',
    ...
    rt_ntrace_loading: '正在加载 NextTrace traceMap…', rt_ntrace_err: '加载 traceMap 失败', rt_ntrace_loaded: 'NextTrace',
  ...
  en: {
    ...
    ov_sources: 'Vantage points', ov_snap: 'Snapshot', ov_ingest: 'Ingested', ov_data: 'Data', ov_build: 'Build', ov_na: 'no data',
    ov_hint: 'Pick a country, or search an IP / ASN / AS_PATH to start',
    best: 'Representative observed path (most peer observations)', lowvis: 'likely not in DFZ', tier1: 'Tier-1 backbone', search: 'Search',
    ...
    clear: 'Clear', src_home: 'Source', feedback: 'Issues', changelog: 'Changelog', menu: 'Menu', friends: 'Links',
    ...
    loading: 'Loading query engine (DuckDB-WASM)…', loading_ext: 'Loading parquet extension…', querying: 'Querying…',
    ...
    exp_irr: 'IRR status', exp_moas: 'MOAS origins', exp_best: 'Representative observed path', exp_segs: 'Sub-prefixes',
    exp_match_peers: 'Matching peer observations', exp_observed_peers: 'All exported peer observations', exp_match_share: 'Matching observation share',
    col_prefix: 'Prefix', col_origin: 'origin asn', col_loc: 'Location', col_path: '#path',
    col_seg: 'Segs', col_match: 'matching observations', match_majority: 'Matched by a majority of peer observations',
    match_hint: 'Matching peer observations / all exported peer observations for this prefix', no_results: 'no results', no_data_cc: 'No data for this country',
    ...
    no_visible_path: 'No visible path: this IP is not observed by any collector.',
    ...
    rel_show_all: 'show all {n}', rel_collapse: 'collapse',
    ...
    sp_egress: 'Egress', sp_paths_title: 'Distinct paths', sp_noup: 'No upstream observed', sp_best: 'representative', sp_next: 'Next card', sp_card_n: 'Card {i} / {n}',
    ...
    rt_north_lock: 'Lock north up', rt_north_unlock: 'Unlock north',
    ...
    rt_collapse_all: 'Collapse all', rt_expand_all: 'Expand all',
    ...
    rt_ntrace_loading: 'Loading NextTrace traceMap…', rt_ntrace_err: 'Failed to load traceMap', rt_ntrace_loaded: 'NextTrace',
